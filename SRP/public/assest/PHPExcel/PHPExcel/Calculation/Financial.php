 ...
 * License as publish by the Free Software Foundation; either
...
class PHPExcel_Calculation_Financial {
	 ...
	 *									when the security is traded to the customer.
	 ...
	 *								date when the security is traded to the customer.
	 ...
	 *
	 * @param	mixed	$settlement	The security's settlement date.
	 *								The security settlement date is the date after the issue date when the security is traded to the customer.
	 * @param	mixed	$maturity	The security's maturity date.
	 *								The maturity date is the date when the security expires.
	 ...
	 *
	 * @param	mixed	settlement	The security's settlement date.
	 *								The security's settlement date is the date after the issue date when the security is traded to the customer.
	 * @param	mixed	maturity	The security's maturity date.
	 *								The maturity date is the date when the security expires.
	 * @param	mixed	issue		The security's issue date.
	 ...
	 *								The Treasury bill's settlement date is the date after the issue date when the Treasury bill is traded to the customer.
