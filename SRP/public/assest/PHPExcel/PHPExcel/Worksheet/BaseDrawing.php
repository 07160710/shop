...
class PHPExcel_Worksheet_BaseDrawing implements PHPExcel_IComparable
{
     ...
     * @param 	bool				$pOverrideOld	If a Worksheet has already been assign, overwrite it and remove image from old Worksheet?
    ...
    public function setWorksheet(PHPExcel_Worksheet $pValue = null, $pOverrideOld = false) {
    	if (is_null($this->_worksheet)) {
    		...
    		if ($pOverrideOld) {
    			...
    			throw new PHPExcel_Exception("A PHPExcel_Worksheet has already been assign. Drawings can only exist on one PHPExcel_Worksheet.");
    		}
    	}
    	return $this;
    }
