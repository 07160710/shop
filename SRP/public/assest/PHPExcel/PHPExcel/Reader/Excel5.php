...
//			var_dump($bcBitCount);
	...
	private function _getNextToken($formulaData, $baseCell = 'A1')
	{
		...
		case 0x1D:	//	boolean
			...
			break;
		case 0x1E:	//	integer
			// offset: 1; size: 2; unsign 16-bit integer
			$name = 'tInt';
			$size = 3;
